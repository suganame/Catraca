...
begin
  ...
  {lembrando que temos o código #0A2B3C, ele ficará do modo abaixo
quando colocarmos o indicador '$' na frente dos dígitos}
//cor := TColor($3C2B0A);
...
//    LblStatus.Caption := 'Efetuar configuração do inner.';
//
//  end
//  else
//  begin

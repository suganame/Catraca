...
type
  ...
  private
    ...
    procedure ConfigurarEntradaMudancasOnline( NumInner : Integer);
...
begin
  ...
  lblStatus.Caption := 'Conectando, Conectar';
...
procedure TFrmPrincipal.ConfigurarEntradaMudancasOnline(InnerAtual: Integer);
var
